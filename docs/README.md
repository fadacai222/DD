...
- P11 E2EE 已于 2026-08-11 明确移出 V1 范围；P12 Admin/Governance/Data Rights 与 P13 U20-U25 Production Self-host/Release 主链已完成代码闭环。P13 剩余的是 `SECRET/HUMAN-PENDING`：真实原生签名证书与 GitHub production approval policy、公网 TURN/跨运营商、真实规模 RPO/RTO、真实告警接收方等；P14 已生成 iOS Runner 并加入 Codemagic 无签名云构建配置，但尚未产生 macOS 云编译、签名/TestFlight 或真机验收证据，正式交付仍未完成。
