...
- P11 E2EE 已于 2026-08-11 明确移出 V1 范围；P12 Admin/Governance/Data Rights 主链与 P13 U20-U24 Production Self-host 已完成总集成自动验证。P13 当前只剩 U25 Release provenance 代码收口以及公网 TURN/跨运营商、真实规模 RPO/RTO、真实告警接收方等 `HUMAN-PENDING`；P14 已生成 iOS Runner 并加入 Codemagic 无签名云构建配置，但本地仓库尚无远端、尚未产生 macOS 云编译证据，正式交付仍未完成。
