...
func TestOpenAPIFormalRuntimeSurface(t *testing.T) {
	...
	expected := map[string][]string{
		...
		"/api/v1/admin/auth/mfa/enroll":                              {"post"},
		"/api/v1/admin/auth/mfa/enroll/verify":                       {"post"},
		"/api/v1/admin/auth/mfa/verify":                              {"post"},
		"/api/v1/admin/auth/logout":                                  {"post"},
		"/api/v1/admin/session":                                      {"get"},
		"/api/v1/admin/sessions":                                     {"get"},
		"/api/v1/admin/sessions/{sessionId}":                         {"delete"},
		"/api/v1/admin/mfa/recovery/regenerate":                      {"post"},
		"/api/v1/admin/settings":                                     {"get"},
		"/api/v1/admin/settings/registration":                        {"put"},
		"/api/v1/admin/admins":                                       {"get", "post"},
		"/api/v1/admin/admins/{adminId}":                             {"patch"},
		"/api/v1/admin/admins/{adminId}/mfa-reset":                   {"post"},
		"/api/v1/admin/dashboard":                                    {"get"},
		"/api/v1/admin/reports":                                      {"get"},
		"/api/v1/admin/reports/{reportId}":                           {"get", "patch"},
		...
		"/api/v1/admin/moments":                                      {"get"},
		"/api/v1/admin/storage":                                      {"get"},
		"/api/v1/admin/push":                                         {"get"},
		"/api/v1/admin/rtc":                                          {"get"},
		"/api/v1/admin/services/health":                              {"get"},
		...
		"/api/v1/data-rights/exports":                                {"post"},
		"/api/v1/data-rights/exports/{exportId}":                     {"get"},
		"/api/v1/data-rights/exports/{exportId}/download":            {"post"},
		"/api/v1/data-rights/account-deletion":                       {"post"},
		"/api/v1/data-rights/account-deletion/{deletionId}":          {"get"},
		"/api/v1/data-rights/account-deletion/{deletionId}/cancel":   {"post"},
		"/api/v1/calls":                                              {"post"},
